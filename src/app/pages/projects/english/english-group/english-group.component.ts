...
import {EnglishGroup, EnglishProfile, EnglishReport} from '../../../../interfaces/services/projects/english.service';

@Component({
  selector: 'english-group',
  templateUrl: './english-group.component.html',
  styleUrls: ['./english-group.component.scss'],
})
export class EnglishGroupComponent extends BasePageComponent implements OnInit, OnDestroy {
  groups: IGroup[];
  ...
  constructor(store: Store<IAppState>,
              ...
              private mini: MiniListComponent,
  ...
  getReportsByGroup() {
    return this.http.get<EnglishReport[]>(`${environment.apiUrl}/api/project/english-project/group/report/${this.id}`)
        .pipe(map(data => {
          return data;
        }))
        .subscribe(data => {
